        ...
        actions = {
            if (showSearch.value.not()) {
                IconButton(onClick = { showSearch.value = true }) {
                    Icon(MdtIcons.Search, null, tint = MdtTheme.color.primary)
                }
            }
            actions()
        },
...
private fun Preview() {
    PreviewTheme {
        TopAppBarWithSearch(
            ...
            actions = {
                IconButton(onClick = {}) {
                    Icon(MdtIcons.Add, null, tint = MdtTheme.color.onSurface)
                }
            },
            navigationClick = {},
        )
...
@PreviewLightDark
@Composable
private fun PreviewSearchActive() {
    PreviewTheme {
        TopAppBarWithSearch(
            title = PreviewText,
            searchHint = "Search",
            showSearch = remember { mutableStateOf(true) },
            navigationClick = {},
        )
    }
}