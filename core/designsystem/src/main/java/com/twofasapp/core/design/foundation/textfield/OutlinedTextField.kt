...
import com.twofasapp.core.design.semantics.fieldError

@Composable
fun textFieldsColors() = outlinedTextFieldColors(
    unfocusedLabelColor = MdtTheme.color.onSurfaceSecondary,
    errorCursorColor = MdtTheme.color.error,
    errorLabelColor = MdtTheme.color.error,
    errorLeadingIconColor = MdtTheme.color.error,
    errorTextColor = MdtTheme.color.error,
    errorTrailingIconColor = MdtTheme.color.error,
    errorBorderColor = MdtTheme.color.error,
)
